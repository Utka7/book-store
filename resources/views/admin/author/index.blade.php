                                ...
                                <div class="card-body table-responsive p-0">
                                    <table class="table table-hover text-nowrap">
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="{{route('admin.author.show', $author->id)}}"><i class="fa fa-eye" aria-hidden="true"></i></a></td>
                                            <td><a href="{{route('admin.author.edit', $author->id)}}"><i class="fa fa-pen" aria-hidden="true"></i></a></td>
                                            <td>
