...
<head>
    ...
    <link rel="shortcut icon" href="../../images/logo/favicon-32x32.png" type="image/x-icon">
    <!-- Bootstrap 5 Css -->
    <link rel="stylesheet" href="{{asset('css/bootstrap.5.1.1.min.css')}}">
    <!-- Google fonts -->
    ...
    <!-- Nice Select Css -->
    <link rel="stylesheet" href="{{asset('css/plugin/nice-select.v1.0.css')}}">
    <!-- Animate Css -->
                            ...
                            <div class="col-12">
                                <div class="some-info">
                                    <p class="d-flex align-items-center"> <span class="icon"> <i
                                                class="flaticon-power"></i> </span> Добро пожаловать в магазин книг Karte</p>
                    ...
                    <div class="row">
                        <div class="menu-info d-flex justify-content-between align-items-center">
                            <div class="menubar"> <span></span> <span></span> <span></span> </div> <a
                                href="index.html" class="logo"> <img src="../../images/logo/logo.png" alt=""> </a>
...
<footer class="footer-default footer-3 ">
    <div class="footer-default__shap_1 position-absolute "> <img src="{{asset('images/shape/footer-shape-1.png')}}"
                                                                 alt=""> </div>
    <!--Start Footer-->
        ...
        <div class="container">
            <div class="footer_bottom_content">
                ...
                <div class="footer-payment wow fadeInUp animated">
                    <a href="#0"> <img src="{{asset('/images/home-four/method-1.jpg')}}" alt="payment"> </a>
                    <a href="#0"> <img src="{{asset('/images/home-four/method-2.jpg')}}" alt="payment"> </a>
                    <a href="#0"> <img src="{{asset('/images/home-four/method-3.jpg')}}" alt="payment"> </a>
                    <a href="#0"> <img src="{{asset('/images/home-four/method-4.jpg')}}" alt="payment"> </a>
                </div>
            </div>
        </div>
    </div>
