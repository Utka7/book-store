                            ...
                            <div class="row">
                                <div class="menu-info d-flex justify-content-between align-items-center">
                                    <div class="menubar"> <span></span> <span></span> <span></span> </div> <a
                                        href="index.html" class="logo"> <img src="../../images/logo/logo.png"
                                                                             alt=""> </a>
                            ...
                            <div class="col-12">
                                <div class="some-info">
                                    <p class="d-flex align-items-center"> <span class="icon"> <i
                                                class="flaticon-power"></i> </span> Добро пожаловать в магазин книг E-store</p>
                            ...
                            <div class="col-12">
                                <div class="mega-menu-default mega-menu d-lg-block d-none">
                                    <div class=" d-flex align-items-right justify-content-between ">
                                        ...
                                        <div class="right d-flex align-items-right justify-content-end m-2">
                                            <ul class="main-menu__widge-box d-flex align-items-right ">
